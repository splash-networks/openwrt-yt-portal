    ...
    <div class="main">
      <section class="section">
        <div class="container">
          ...
          <form id="verify_email" method="post" action="verify.php" style="display:none">
...
<script>
    ...
    const sms_form = document.getElementById('verify_sms');
    const email_form = document.getElementById('verify_email');
